...
const TransactionDetails = (props) => {
  ...
  return (
    <div className={addPrefixClass(`widget-exchange__order theme-border ${isUnlockWalletStep ? 'common__desktop-display' : ''}`)}>
      <div className={addPrefixClass("widget-exchange__order-header")}>{props.translate('transaction.title') || "Transaction Details"}</div>

      <div className={addPrefixClass("widget-exchange__order-body")}>
        <div className={addPrefixClass("widget-exchange__order-box")}>
          <span className={addPrefixClass("widget-exchange__order-text")}>{props.translate('common.from') || "From"}</span>
        ...
        <div className={addPrefixClass("widget-exchange__order-box")}>
          <span className={addPrefixClass("widget-exchange__order-text")}>{props.translate('common.to') || "To"}</span>
          <span className={addPrefixClass("widget-exchange__order-text-bolder")}>
        ...
        {props.exchange.step === 3 && (
          <div className={addPrefixClass("widget-exchange__order-box widget-exchange__order-address theme-border")}>
            <div className={addPrefixClass("widget-exchange__order-text")}>{props.translate('transaction.fee') || "Transaction Fee"}:</div>
