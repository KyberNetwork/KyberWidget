                ...
                {!props.exchange.isSelectToken && (
                  <div>
                    {props.exchange.sourceTokenSymbol !== props.exchange.destTokenSymbol && (
                      <div>{props.exchange.offeredRate == "0" ? 0 : converter.calculateDest(props.exchange.sourceAmount, props.exchange.offeredRate, props.exchange.commissionFee, 6)} {props.exchange.destTokenSymbol}</div>
                    )}
                    {props.exchange.sourceTokenSymbol === props.exchange.destTokenSymbol && (
