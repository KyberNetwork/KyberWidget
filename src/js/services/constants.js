...
module.exports = {
  ...
  IMPORT_ACCOUNT_TYPE, MAX_AMOUNT_RATE_HANDLE, SUPPORTED_NETWORK, APP_NAME, PAYMENT_PATH, VERSION, PERM_HINT, STABLE_COINS, ETHEREMON_WRAPPER
}
