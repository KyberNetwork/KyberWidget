          ...
          <div className="content">
            ...
            {this.props.exchange.isHaveDestAmount && (
              <div>
                ...
                <span>
                  {converter.roundingNumber(this.props.exchange.destAmount)} {this.props.exchange.destTokenSymbol}
                </span>
              </div>
            )}
          </div>
        ...
        <div className="payment-info">
          ...
          <div className="content">
            <div>
              ...
              {this.props.exchange.isHaveDestAmount && this.props.exchange.sourceTokenSymbol === this.props.exchange.destTokenSymbol && (
                <span>{converter.roundingNumber(this.props.exchange.destAmount)} {this.props.exchange.destTokenSymbol}</span>
              )}
              {!this.props.exchange.isHaveDestAmount && (
                <span>{converter.roundingNumber(this.props.exchange.sourceAmount)} {this.props.exchange.sourceTokenSymbol}</span>
              )}
            </div>
            <div>
