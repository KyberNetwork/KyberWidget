...
- ***receiveAddr*** (ethereum address with 0x prefix) - vendor's Ethereum wallet, user's payment will be sent there. *Must double check this param very carefully*. If you leave it blank or missing or 'self', the widget will have SWAP layout, and user can swap tokens with this interface.
